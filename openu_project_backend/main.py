...
from config import TOKEN, BOT_USERNAME, Category, Button, Status, Command, categories_config, categories_config_dict, PASSWORD_MAX_LENGTH, PASSWORD_MIN_LENGTH, LOGIN_NAME_MIN_LENGTH, LOGIN_NAME_MAX_LENGTH
...
async def set_password(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if succeed == None:
        ...
        #await update.message.edit_text(text="Password has been successfully updated !")
        await update.message.delete()
        await context.bot.send_message(chat_id=update.message.chat_id, text="Password has been successfully updated!")
        #await update.message.reply_text(f"hey {update.message.from_user.first_name}, your new password has been updated!")
